...
// Features:
// - SQLite persistence
// - Brand CRUD with rich settings (tone, bans, pillars/formats with weights, CTA rules)
// - GPT-5 draft generation that respects brand settings; stores pillar/format metadata per post
// - Approve / schedule / (stub) publish to LinkedIn
// - Cron that auto-publishes approved posts when due
